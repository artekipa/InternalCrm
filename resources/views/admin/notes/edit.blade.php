        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('catnotes_id[]', $catnotes_ids, old('catnotes_id') ? old('catnotes_id') : $note->catnotes_id->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple', 'id' => 'selectall-catnotes_id' ]) !!}
                    <p class="help-block"></p>
