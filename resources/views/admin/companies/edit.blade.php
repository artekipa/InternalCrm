        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::hidden('adress_latitude', $company->adress_latitude , ['id' => 'adress-latitude']) !!}
                    {!! Form::hidden('adress_longitude', $company->adress_longitude , ['id' => 'adress-longitude']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('vivode_id[]', $vivode_ids, old('vivode_id') ? old('vivode_id') : $company->vivode_id->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple', 'id' => 'selectall-vivode_id' ]) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('trades_id[]', $trades_ids, old('trades_id') ? old('trades_id') : $company->trades_id->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple', 'id' => 'selectall-trades_id' ]) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('nomiyear_id[]', $nomiyear_ids, old('nomiyear_id') ? old('nomiyear_id') : $company->nomiyear_id->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple', 'id' => 'selectall-nomiyear_id' ]) !!}
                    <p class="help-block"></p>
        ...
        <div class="panel-body">
            <table class="table table-bordered table-striped">
                ...
                <tbody id="nominowane-firmy">
                    ...
                    @empty
                        @foreach($company->nominateds as $item)
                            @include('admin.companies.nominateds_row', [
                                'index' => 'id-' . $item->id,
                                'field' => $item
                            ])
