...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.adverts.store']]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('catadver_id[]', $catadver_ids, old('catadver_id'), ['class' => 'form-control select2', 'multiple' => 'multiple', 'id' => 'selectall-catadver_id' ]) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('team_id[]', $team_ids, old('team_id'), ['class' => 'form-control select2', 'multiple' => 'multiple', 'id' => 'selectall-team_id' ]) !!}
                    <p class="help-block"></p>
