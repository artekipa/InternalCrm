        ...
        <div class="panel-body">
                ...
                <div class="col-xs-12 form-group">
                    ...
                    <div class="photo-block">
                        ...
                        <div class="files-list">
                            @foreach($project->getMedia('imgsrc') as $media)
                                <p class="form-group">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('awards_id[]', $awards_ids, old('awards_id') ? old('awards_id') : $project->awards_id->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple', 'id' => 'selectall-awards_id' ]) !!}
                    <p class="help-block"></p>
