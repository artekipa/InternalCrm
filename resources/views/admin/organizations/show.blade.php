                ...
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        <tr>
                            ...
                            <td field-key='name'>{{ $organization->name }}</td>
                        </tr>
                        <tr>
                            <th>@lang('global.organization.fields.imgsrc')</th>
                            <td field-key='imgsrc'> @foreach($organization->getMedia('imgsrc') as $media)
                                <p class="form-group">
                        ...
                        <tr>
                            ...
                            <td field-key='desc'>{!! $organization->desc !!}</td>
                        </tr>
                    </table>
                </div>
            </div><!-- Nav tabs -->
...
{!! Form::open(array(
        ...
        @endif
            ...
            <a href="{{ route('admin.organizations.index') }}" class="btn btn-default">@lang('global.app_back_to_list')</a>
        </div>
    </div>
@stop
