...
class TasksController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.tasks.create', compact('statuses', 'tags', 'users', 'created_bies', 'created_by_teams'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.tasks.edit', compact('task', 'statuses', 'tags', 'users', 'created_bies', 'created_by_teams'));
    }
