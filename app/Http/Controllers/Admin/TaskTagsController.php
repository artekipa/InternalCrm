...
class TaskTagsController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($filterBy = Input::get('filter')) {
            if ($filterBy == 'all') {
                Session::put('TaskTag.filter', 'all');
            } elseif ($filterBy == 'my') {
                Session::put('TaskTag.filter', 'my');
            }
        }
        if ($filterBy = Input::get('filter')) {
            if ($filterBy == 'all') {
    ...
    public function create()
    {
        ...
        return view('admin.task_tags.create', compact('created_bies', 'created_by_teams'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.task_tags.edit', compact('task_tag', 'created_bies', 'created_by_teams'));
    }
    ...
    public function show($id)
    {
        ...
        $created_bies = \App\User::get()->pluck('name', 'id')->prepend(trans('global.app_please_select'), '');
        $created_by_teams = \App\Team::get()->pluck('name', 'id')->prepend(trans('global.app_please_select'), '');$tasks = \App\Task::whereHas('tag',
