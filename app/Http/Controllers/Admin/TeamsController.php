...
class TeamsController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $task_tags = \App\TaskTag::where('created_by_team_id', $id)->get();$catnotes = \App\Catnote::where('created_by_team_id', $id)->get();$years = \App\Year::where('created_by_team_id', $id)->get();$vivodeships = \App\Vivodeship::where('created_by_team_id', $id)->get();$adverts = \App\Advert::whereHas('team_id',
                    function ($query) use ($id) {
                        $query->where('id', $id);
                    })->get();$notes = \App\Note::where('created_by_team_id', $id)->get();$awards = \App\Award::where('created_by_team_id', $id)->get();$tasks = \App\Task::where('created_by_team_id', $id)->get();$users = \App\User::where('team_id', $id)->get();

        $team = Team::findOrFail($id);

        return view('admin.teams.show', compact('team', 'task_tags', 'catnotes', 'years', 'vivodeships', 'adverts', 'notes', 'awards', 'tasks', 'users'));
    }
